...
<del><span class="product-price regprice">{{$product->sale_price}} Kyats</span></del>
</div>
@else
		...
		<li class="comment byuser comment-author-admin bypostauthor even thread-even depth-1" id="li-comment-20">
			<div id="comment-20" class="comment_container"> 
				...
				<div class="comment-text">
					...
					<p class="meta"> 
						<strong class="woocommerce-review__author">{{Carbon\Carbon::parse($orderItem->review->created_at)->format('d F Y g:i A')}}</strong> 
						<span class="woocommerce-review__dash">–</span>
						<time class="woocommerce-review__published-date" datetime="2008-02-14 20:00" >{{$orderItem->review->created_at}}</time>
					</p>
