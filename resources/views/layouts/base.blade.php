...
<title>J Garden Indoor Plants & Accessories</title> 
...
<div class="topbar-menu left-menu">
    <ul>
        <li class="menu-item" >
            <a title="09 769 917773" href="#" ><span class="icon label-before fa fa-mobile"></span>Phone :+95 9 769 917773</a>
        </li>
    </ul>
</div>
...
<div class="wrap-logo-top left-section">
    <a href="/" class="link-to-home"><img src="{{asset('assets/images/logo.jpg')}}" alt="J Garden Indoor Plants & Accessories"></a>
</div>
...
<div class="container">
    <ul class="nav primary clone-main-menu col-md-offset-4" id="mercado_main" data-menuname="Main menu" >
...
<p class="coppy-right-text">Copyright © 2021 J Garden Indoor Plants & Accessories. All rights reserved</p>
</div>
...
<!-- <script src="{{asset('assets/js/chosen.jquery.min.j')}}s"></script> -->
...
<script src="https://cdn.tiny.cloud/1/gwsu2s9twgadz73ysmjan2m08ls051uvof17lwx5jwv4uthp/tinymce/5/tinymce.min.js" referrerpolicy="origin"></script>
